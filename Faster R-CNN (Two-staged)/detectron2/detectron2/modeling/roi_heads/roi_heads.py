...
from ..sampling import subsample_labels,subsample_labels_biased
...
class ROIHeads(torch.nn.Module):
    ...
    def _sample_proposals(
        ...
        sampled_fg_idxs, sampled_bg_idxs = subsample_labels_biased(#subsample_labels(
    ...
    def label_and_sample_proposals(
        ...
        for proposals_per_image, targets_per_image in zip(proposals, targets):
            ...
            matched_idxs, matched_labels, matched_iou = self.proposal_matcher(match_quality_matrix)
